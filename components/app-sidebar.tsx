...
interface CustomSidebarProps {
  // Use the single data object for all fetched content
  data: {
    user: UserType;
    appointments: AppointmentType[];
    profile: DoctorType | PatientType | undefined;
  };
  // Keep optional props separate if they are not part of the main data fetching
  unreadCount?: number;
}

// 2. Define the final combined props type
type AppSidebarProps = CustomSidebarProps &
