...
import { CalendarCheck, CalendarCheckIcon, Trash2Icon } from "lucide-react";
  ...
  return (
    <Dialog modal open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>
            {event?.id ? "Modifier évenement" : "Créer évenement"}
          </DialogTitle>
        ...
        <div className="grid gap-4 py-4">
          <div className="*:not-first:mt-1.5">
            <Label htmlFor="title">Titre de l'évenement</Label>
            <Input
              id="title"
              value={title}
