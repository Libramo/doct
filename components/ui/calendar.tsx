...
function Calendar({
  ...
  const defaultClassNames = {
    ...
    today:
      "*:after:pointer-events-none *:after:absolute *:after:bottom-1 *:after:start-1/2 *:after:z-10 *:after:w-[12px] *:after:h-[2px] *:after:-translate-x-1/2 *:after:rounded-sm *:after:bg-primary [&[data-selected]:not(.range-middle)>*]:after:bg-background [&[data-disabled]>*]:after:bg-foreground/30 *:after:transition-colors",
    outside:
